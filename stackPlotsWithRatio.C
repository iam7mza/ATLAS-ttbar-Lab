...
int main() {
  ...
  PlotStackWithRatio(output_lep_phi, "#phi (l)", h_mc_lep_phi_stacked, h_data_lep_phi, leg);
  ...
  PlotStackWithRatio(output_jet_phi, "#phi (jets)", h_mc_jet_phi_stacked, h_data_jet_phi, leg);
  PlotStackWithRatio(output_jet_E, "E (jets) [GeV]", h_mc_jet_E_stacked, h_data_jet_E, leg);  
    
  PlotStackWithRatio(output_ljet_pt, "p_{T} (ljet) [GeV]", h_mc_ljet_pt_stacked, h_data_ljet_pt, leg);
  PlotStackWithRatio(output_ljet_eta, "#eta (ljet)", h_mc_ljet_eta_stacked, h_data_ljet_eta, leg);
  PlotStackWithRatio(output_ljet_phi, "#phi (ljet)", h_mc_ljet_phi_stacked, h_data_ljet_phi, leg);
  PlotStackWithRatio(output_ljet_E, "E (ljet) [GeV]", h_mc_ljet_E_stacked, h_data_ljet_E, leg);  
